...
<section id="aktualnosci" class="mx-auto max-w-6xl px-4 py-12">
    ...
    <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
        ...
        <a href="{{ site_route('news.index') }}" class="rounded bg-brand px-4 py-2 text-xs font-bold uppercase tracking-wide text-white hover:bg-brand-dark focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand">Zobacz wszystkie</a>
    </div>

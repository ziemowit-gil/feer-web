...
<section class="bg-gray-50 py-14" aria-labelledby="federacja-network-heading">
    <div class="mx-auto max-w-[1400px] px-4">

        <div class="mb-8">
            <h2 id="federacja-network-heading" class="text-2xl font-extrabold text-gray-900 md:text-3xl">
                Nasza sieć
            </h2>

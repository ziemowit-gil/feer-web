...
@section('content')
    <section class="mx-auto flex max-w-2xl flex-col items-center px-4 py-20 text-center">
        ...
        <p class="mb-2 text-sm font-bold uppercase tracking-wide text-brand">Błąd 403</p>
        <h1 class="mb-3 text-3xl font-bold text-ink">Brak dostępu</h1>
        <p class="mb-8 max-w-md text-muted">
            Nie masz uprawnień do wyświetlenia tej strony. Jeśli uważasz, że to błąd, skontaktuj się z nami.
        </p>

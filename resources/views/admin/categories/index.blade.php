...
@section('content')
    <div class="mb-4 flex justify-end">
        <a href="{{ route('admin.kategorie.create') }}" class="rounded bg-brand px-4 py-2 text-sm font-bold text-white hover:bg-brand-dark">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-end gap-3">
                                <a href="{{ route('categories.show', $category) }}" target="_blank" class="text-muted hover:text-brand" title="Podgląd"><i class="fa-solid fa-eye"></i></a>
                                <a href="{{ route('admin.kategorie.edit', $category) }}" class="text-muted hover:text-brand" title="Edytuj"><i class="fa-solid fa-pen"></i></a>

...
class SiteSetting extends Model implements HasMedia
{
    ...
    /**
     * BIP display modes: 'internal' uses the built-in document module,
     * 'external' shows a link to a separately hosted BIP service.
     */
    public const BIP_MODES = [
        'internal' => 'Własny BIP (dokumenty wbudowane)',
        'external' => 'Zewnętrzny BIP (odnośnik do innej strony)',
    ];
    ...
    protected $fillable = [
        ...
        'contact_show_form', 'contact_show_bank_accounts', 'contact_show_coordinators',
    ...
    protected $casts = [
        ...
        'contact_show_bank_accounts' => 'boolean',
        'contact_show_coordinators' => 'boolean',
        ...
        'wide_mission_nav_hover_white' => 'boolean',
        'wide_mission_nav_active_white' => 'boolean',
        'wide_mission_nav_icons_white' => 'boolean',
        'logo_only' => 'boolean',
    ...
    /** Czy na /kontakt pokazać wyróżnioną uwagę o kierowaniu korespondencji. */
    ...
    public function correspondenceTitle(): string
    {
        return filled($this->contact_correspondence_title)
            ? $this->contact_correspondence_title
            : 'Ważne: kierowanie korespondencji';
    }

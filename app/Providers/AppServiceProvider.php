...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer(['partials.header', 'templates.municipality.partials.header', 'templates.ngo.partials.header', 'templates.wrzos.partials.header'], function ($view) {
        ...
        View::composer(['partials.footer', 'templates.municipality.partials.footer', 'templates.ngo.partials.footer', 'templates.wrzos.partials.footer'], function ($view) {
            $siteSettings = SiteSetting::current();
